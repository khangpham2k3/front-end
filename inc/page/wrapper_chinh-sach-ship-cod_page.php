    ...
    <div class="container">
        <div class="row">
            ...
            <p>
                Mong muốn mang lại dịch vụ tốt nhất cho khách hàng, ShopDunk hợp tác cùng Viettel Post triển khai dịch
                vụ ship COD <br>
                toàn quốc. Dù ở bất kỳ tỉnh thành nào trên toàn quốc, bạn vẫn có thể mua hàng tại ShopDunk – Đại lý uỷ
                quyền Apple
            </p>
            <h3>
            ...
            <div class="container">
                <ul>
                    ...
                    <li style="list-style: none;">Sau khi chọn được sản phẩm ưng ý, khách hàng để lại thông tin cụ thể
                        của mình, nhân viên tư vấn
                        xin thông tin khách hàng (xác nhận chính xác):</li>
                    ...
                    <li style="list-style: none;">Trường hợp không nhận trực tiếp, khách hàng cần cung cấp đầy đủ thông
                        tin người đặt hàng và người nhận:</li>
                    <li style="list-style: none;">
                        <ol type="1">
            ...
            <p>Với sản phẩm có giá trị cao, ShopDunk luôn gửi đi kèm bảo hiểm giá trị hàng hoá. Khách hàng cọc tiền để
                được đảm bảo về chất lượng vận chuyển luôn được tốt nhất.Quy định giá trị đặt cọc như sau: </p>
            ...
            <div class="container">
                <ul>
                    ...
                    <li class="my-2">Khách hàng sẽ được nhận các thông tin về đơn hàng trước khi kiện hàng được ShopDunk
                        gửi đi:</li>
                    <li style="list-style: none;">
                        <ol type="1">
