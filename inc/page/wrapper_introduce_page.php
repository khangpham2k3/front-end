        ...
        <div class="page_introduce m-auto text-center">
            <div class="introduce-1 mb-5">
                ...
                <p class="page_introduce-content">
                    ...
                    công
                    nghệ
                    tại Việt Nam. Chúng tôi là đối tác ủy quyền tin cậy của các hãng công nghệ uy tín hàng đầu trên thế
                    giới
                    như Apple, Samsung trong lĩnh vực thương mại và dịch vụ. Điều tuyệt vời nhất ở Cyber Mart chính là,
                    khi
                    chúng ta trở thành đồng nghiệp, đối tác hay khách hàng của nhau, chúng ta đã trở thành người một
                    nhà. Ở
                    mỗi điểm chạm, chúng ta luôn kết nối, bàn bạc và trao đổi để cùng thống nhất mục tiêu chung, bởi
                    chúng
                    ta không có khoảng cách.
                </p>
            </div>
            ...
            <div class="introduce-title_value mb-5">
                ...
                <p>HESMAN Group đã tạo nên một lịch sử mới cho thương hiệu ShopDunk, xóa nhòa đi mọi định kiến và khái
                    ...
                    thành đối tác uy tín của những hãng công nghệ hàng đầu thế giới.</p>
                <p>
            ...
            <div class="introduce-tamnhin mb-5">
                ...
                <ul>
                    <li>
                        ...
                        mua sắm cho khách hàng từ những nhu cầu nhỏ nhất với hệ thống stores rộng khắp trên toàn quốc.
                    </li>
                    <li>
