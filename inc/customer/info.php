                    ...
                    <div class=" side-2 collapse navbar-collapse " id="navbarNavDropdown">
                        <div class="list-group listbox">
                            <div class="slidebar_list-tem ">
                                <a href="#" class="active list-group-item list-group-item-action border-0 fw-semibold"><i class="me-2 fa-solid fa-user "></i> Thông tin tài khoản</a>
                            </div>
                            <div class="slidebar_list-tem">
                            ...
                            <div class="slidebar_list-tem">
                                <a href="#" class="inactive list-group-item list-group-item-action border-0 fw-semibold"><i class="me-2 fa-solid fa-clock-rotate-left"></i> Lịch sử đánh giá sản phẩm</a>
                            </div>
                        </div>
                    </div>
                </div>
